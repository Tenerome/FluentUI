...
Item {
    ...
    QtObject {
        ...
        property bool isCompactAndPanel: d.displayMode === FluNavigationView.Compact
                                         && d.enableNavigationPanel
        property bool isCompactAndNotPanel: d.displayMode === FluNavigationView.Compact
                                            && !d.enableNavigationPanel
        property bool isMinimalAndPanel: d.displayMode === FluNavigationView.Minimal
                                         && d.enableNavigationPanel
        ...
        Item {
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    visible: {
                        for (var i = 0; i < model.children.length; i++) {
                            ...
                            if (item.idx === nav_list.currentIndex
                                    && !model.isExpand) {
                                return true
                            }
                        }
                ...
                MouseArea {
                    ...
                    onClicked: {
                        if (d.isCompactAndNotPanel) {
                            control_popup.showPopup(Qt.point(50,
                                                             mapToItem(control,
                                                                       0,
                                                                       0).y),
                                                    model.children)
                ...
                color: {
                    if (FluTheme.dark) {
                        if (type === 0) {
                            ...
                            if (nav_list.currentIndex
                                    === (nav_list.count - layout_footer.count + idx)) {
                                return Qt.rgba(1, 1, 1, 0.06)
                            }
                        }
                        if (item_mouse.containsMouse) {
            ...
            FluIconButton {
                ...
                onClicked: {
                    ...
                    if (item.idx < (nav_list.count - layout_footer.count)) {
                        ...
                        console.debug(
                                    item.idx - (nav_list.count - layout_footer.count))
                        layout_footer.currentIndex = item.idx
                                - (nav_list.count - layout_footer.count)
                    }
    ...
    Item {
        anchors {
            left: d.isMinimal
                  || d.isCompactAndPanel ? parent.left : layout_list.right
    ...
    Rectangle {
        ...
        border.color: FluTheme.dark ? Qt.rgba(
                                          ...
                                          1) : Qt.rgba(226 / 255, 230 / 255, 234 / 255, 1)
        ...
        color: {
            ...
            if (window && window.active) {
                return FluTheme.dark ? Qt.rgba(
                                           ...
                                           1) : Qt.rgba(238 / 255, 244 / 255, 249 / 255, 1)
            }
            return FluTheme.dark ? Qt.rgba(
                                       32 / 255, 32 / 255, 32 / 255,
                                       1) : Qt.rgba(243 / 255, 243 / 255, 243 / 255, 1)
        ...
        Item {
            ...
            FluIconButton {
                ...
                hoverColor: FluTheme.dark ? Qt.rgba(1, 1, 1,
                                                    0.03) : Qt.rgba(0,
                                                                    0, 0, 0.03)
                pressedColor: FluTheme.dark ? Qt.rgba(1, 1, 1,
                                                      0.03) : Qt.rgba(0, 0, 0,
                                                                      0.03)
                normalColor: FluTheme.dark ? Qt.rgba(0, 0, 0,
                                                     0) : Qt.rgba(0, 0, 0, 0)
                width: 38
                height: 34
                x: 6
    ...
    Popup {
        ...
        background: Rectangle {
            ...
            color: FluTheme.dark ? Qt.rgba(
                                       51 / 255, 48 / 255, 48 / 255,
                                       1) : Qt.rgba(248 / 255, 250 / 255, 253 / 255, 1)
                        ...
                        color: {
                            if (hovered) {
                                return FluTheme.dark ? Qt.rgba(
                                                           63 / 255, 60 / 255,
                                                           61 / 255,
                                                           1) : Qt.rgba(237 / 255, 237
                                                                        / 255, 242 / 255, 1)
                            }
                            return FluTheme.dark ? Qt.rgba(51 / 255,
                                                           48 / 255, 48 / 255,
                                                           1) : Qt.rgba(0, 0,
                                                                        0, 0)
                        }
